...
#define CARDIA_L3       16
#define CARDIA_RR_HIDDEN 16
#define CARDIA_FC1_OUT  32
#define CARDIA_FUSED_LEN 48

/* --- quantisation parameters --- */
#define CARDIA_INPUT_SCALE  4.326493880e-02f
#define CARDIA_INPUT_ZP     (-22)
#define CARDIA_C1_OUT_ZP    (-128)
#define CARDIA_C2_OUT_ZP    (-128)
#define CARDIA_C3_OUT_ZP    (-128)
#define CARDIA_RR_IN_SCALE  3.647856385e-03f
#define CARDIA_RR_IN_ZP     (-128)
#define CARDIA_RRFC_MULT    (1859190028)
#define CARDIA_RRFC_SHIFT   (-8)
#define CARDIA_FUSED_SCALE  9.516643075e-03f
#define CARDIA_FUSED_ZP     (-128)
#define CARDIA_GAP_MULT     (1472693403)
#define CARDIA_GAP_SHIFT    (-2)
#define CARDIA_FC1_MULT     (1550079096)
...
#define CARDIA_LOGIT_SCALE  1.261558076e-04f
...
extern const int8_t  cardia_rrfc_w[64];
extern const int32_t cardia_rrfc_b[16];
extern const int8_t  cardia_fc1_w[1536];
...
#define CARDIA_MODEL_PARAM_BYTES 6188
